...
3. minikube相关的内容直接跳过，我用的docker desktop kubernetes, 发现跳过minikube完全没有影响，大家不要受minikube影响。
4. 官方例子学习流程建议:
...
10. K8S挺复杂，但是入门非常简单，我花了一天左右时间跑官方的例子，感觉挺顺利的。大家别怕，有问题加我微信，个人介绍里面有。
# 关于
...
3. kubectl proxy
4. dashboard访问地址:  http://localhost:8001/api/v1/namespaces/kubernetes-dashboard/services/https:kubernetes-dashboard:/proxy/
5. local json data: http://127.0.0.1:8001
5. error: no endpoints available for service \"kubernetes-dashboard\
